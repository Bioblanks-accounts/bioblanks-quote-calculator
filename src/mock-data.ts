...
export const mockConfig: ConfigSchema = {
  ...
  products: [
    {
      ...
      priceBreaks: [
        { minQty: 1,   unit: 29.90 },
        { minQty: 25,  unit: 26.50 },
        { minQty: 50,  unit: 24.90 },
        { minQty: 100, unit: 22.90 }
      ],
      baseDevCost: 0
    },
    {
      ...
      priceBreaks: [
        { minQty: 1,   unit: 12.90 },
        { minQty: 25,  unit: 11.50 },
        { minQty: 50,  unit: 10.90 },
        { minQty: 100, unit: 9.90 }
      ],
      baseDevCost: 0
    },
    {
      ...
      priceBreaks: [
        { minQty: 1,   unit: 16.90 },
        { minQty: 25,  unit: 14.50 },
        { minQty: 50,  unit: 13.20 },
        { minQty: 100, unit: 11.90 }
      ],
      baseDevCost: 0
    }
  ],
  options: {
    colors: [
      ...
      { id: "navy", label: "Navy Blue", add: 0.50 },
      { id: "red", label: "Red", add: 0.50 },
    ...
    artwork: [
      ...
      { id: "front-back-1c", label: "Front + Back 1-color", addPerUnit: 1.50, devCost: 65 },
      { id: "full-color", label: "Full-color print", addPerUnit: 2.90, devCost: 85 }
    ],
    neckLabel: [
